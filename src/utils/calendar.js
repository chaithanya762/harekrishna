// Official 2026 ISKCON Vaishnava Calendar Data with ISO Dates for Dynamic Sorting
export const ISKCON_CALENDAR_2026 = [
  {
    isoDate: '2026-01-29',
    dateStr: 'January 29, 2026',
...
export function getNextUpcomingEvents(referenceDate = new Date()) {
  ...
  return {
    nextEkadashi,
    nextFestival,
    totalUpcoming: listToUse.length
  };
}
